...
class InteractiveCube(plt.Axes):
    def __init__(self, cube=None,
        ...
        self._start_rot = Quaternion.from_v_theta((1, -1, 0),
                                                  -np.pi / 6)
        self.init_actions = cube.init_actions
    ...
    def _initialize_widgets(self):
        ...
        self._ax_create = self.figure.add_axes([0.65, 0.0005, 0.2, 0.075])

        self._btn_solve = widgets.Button(self._ax_solve, 'Solve Cube')
        self._btn_create_problem = widgets.Button(self._ax_create, 'Create Cube')

        self._btn_solve.on_clicked(self._solve_cube)
        self._btn_create_problem.on_clicked(self._create_problem_cube)
